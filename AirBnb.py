...
st.set_page_config(page_title="AirBnb-Analysis by Akash K!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\Admin\OneDrive\Desktop\Airbnb Analysis")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"AKASH K"}')
    mail = (f'{"Mail :"}  {"aakashcivil002@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/Aakashkarthikeyan002",
        "LINKEDIN": "https://www.linkedin.com/in/aakash-karthikeyan-24aa39196/"}
